...
pg_run_command 'CREATE EXTENSION IF NOT EXISTS \"uuid-ossp\";' 'fede_subscriptions_db'
...
pg_run_command 'CREATE EXTENSION IF NOT EXISTS \"uuid-ossp\";' 'fede_subscriptions_db_test'